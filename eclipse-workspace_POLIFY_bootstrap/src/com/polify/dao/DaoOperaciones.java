...
public class DaoOperaciones {
	...
	public List<Operaciones> getAllOperacionesByArtist(java.util.Date date, java.util.Date date2, Integer artistId) {
		...
		try {
			...
			if (date != null && date2 != null) {
				query = "begin ? := GETARTISTOPERATION(" + artistId + ",to_date('" + convertStringToDate(fi)
						+ "','dd/mm/yyyy'),to_date('" + convertStringToDate(ff) + "','dd/mm/yyyy')); end;";
			} else if (date != null && date2 == null) {
				query = "begin ? := GETARTISTOPERATION(" + artistId + ",to_date('" + convertStringToDate(fi)
						+ "','dd/mm/yyyy'), null ); end;";
			} else if (date == null && date2 != null) {
				query = "begin ? := GETARTISTOPERATION(" + artistId + ",null,to_date( '" + convertStringToDate(ff)
						+ "','dd/mm/yyyy')); end;";
			} else {
	...
	public List<Operaciones> getAllOperacionesByDiffuserCompany(java.util.Date date, java.util.Date date2,
			Integer companyId) {
		List<Operaciones> operacionesList = new LinkedList<>();
		java.sql.Date fi = null;
		java.sql.Date ff = null;
		...
		try {
			String query = "";
			if (date != null && date2 != null) {
				query = "begin ? := GETDIFFUSERCOMPANYOPERATION(" + companyId + ",to_date('" + convertStringToDate(fi)
						+ "','dd/mm/yyyy'),to_date('" + convertStringToDate(ff) + "','dd/mm/yyyy')); end;";
			} else if (date != null && date2 == null) {
				query = "begin ? := GETDIFFUSERCOMPANYOPERATION(" + companyId + ",to_date('" + convertStringToDate(fi)
						+ "','dd/mm/yyyy'),null); end;";
			} else if (date == null && date2 != null) {
				query = "begin ? := GETDIFFUSERCOMPANYOPERATION(" + companyId + ",null,to_date('"
						+ convertStringToDate(ff) + "','dd/mm/yyyy')); end;";
			} else {
	...
	public List<Operaciones> getAllOperacionesRanking(java.util.Date date, java.util.Date date2) {
		...
		try {
			String query = "";
			if (date != null && date2 != null) {
				query = "begin ? := GETRANKINGOPERATION(to_date('" + convertStringToDate(fi)
						+ "','dd/mm/yyyy'),to_date(" + convertStringToDate(ff) + "','dd/mm/yyyy')); end;";
			} else if (date != null && date2 == null) {
				query = "begin ? := GETRANKINGOPERATION(to_date('" + convertStringToDate(fi)
						+ "','dd/mm/yyyy'),null); end;";
			} else if (date == null && date2 != null) {
				query = "begin ? := GETRANKINGOPERATION(null,to_date(" + convertStringToDate(ff)
						+ "','dd/mm/yyyy')); end;";
			} else {
